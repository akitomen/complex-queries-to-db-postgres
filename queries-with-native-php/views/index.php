...
<head>
	...
	<title>1a test postgreSQL with native php</title>
	...
	<div class="row gy-5">
		<div class="col-12">
			<div class="p-3">
				...
				<hr>
				<form action="/object-type-values" method="post" data-field="addressObjectTypeField">
					<div class="mb-3">
						<label for="addressObjectTypeCode" class="form-label">Address Object Type Code</label>
						<input type="text" class="form-control" id="addressObjectTypeCode" name="addressObjectTypeCode" required>
					</div>
	...
	<div class="row gy-5">
		<div class="col-12">
			<div class="p-3">
				...
				<hr>
				<form action="/addresses-for-pickup-points" method="post" data-field="addressesForPickupPointField">
					<button type="submit" class="btn btn-primary">Send Request</button>
				</form>
				<div class="container">
					<div class="row" id="addressesForPickupPointField"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row gy-5">
		<div class="col-12">
			<div class="p-3">
				...
				<hr>
				<form action="/create-address" method="post" data-field="createAddress" id="createAddressForm">
					<div class="mb-2">
					...
					<div class="address-fields">
                        <?php require __DIR__ . '/../views/address-fields.php' ?>
					</div>
					<button type="submit" class="btn btn-primary">Send Request</button>
				</form>
				<div class="container">
	...
	<div class="row gy-5">
		<div class="col-12">
			<div class="p-3">
				...
				<hr>
				<form action="/address-display-values" method="post" data-field="addressDisplayValuesField">
					<div class="mb-3">
	...
	<div class="row gy-5">
		<div class="col-12">
			<div class="p-3">
				...
				<hr>
				<form action="/delivery-fee" method="post" data-field="deliveryFeeField">
					<div class="mb-3">
	...
	<div class="row gy-5">
		<div class="col-12">
			<div class="p-3">
				...
				<hr>
				<form action="/change-dpd-delivery-for-riga" method="post" data-field="changeDpdDeliveryForRigaField">
					<button type="submit" class="btn btn-primary">Send Request</button>
				</form>
				<div class="container">
					<div class="row">
	...
	<div class="row gy-5">
		<div class="col-12">
			<div class="p-3">
				...
				<hr>
				<form action="/delivery-fee-with-day-condition" method="post" data-field="deliveryFeeWithDayConditionField">
					<div class="mb-3">
						<label for="deliveryTypeCode" class="form-label">Delivery Type Code</label>
						<select id="deliveryTypeCode" name="deliveryTypeCode" required class="form-select">
                            <?php
	...
	<div class="row gy-5">
		<div class="col-12">
			<div class="p-3">
				...
				<hr>
				<form action="/delivery-point-count" method="post" data-field="deliveryPointsCountField">
					<button type="submit" class="btn btn-primary">Send Request</button>
				</form>
				<div class="container">
	...
	<div class="row gy-5">
		<div class="col-12">
			<div class="p-3">
				...
				<hr>
				<form action="/add-delivery-configuration" method="post" data-field="addDeliveryConfigurationField">
					<button type="submit" class="btn btn-primary">Send Request</button>
				</form>
				<div class="container">
					<div class="row">
	...
	<div class="row gy-5">
		<div class="col-12">
			<div class="p-3">
				...
				<hr>
				<form action="/normalize-phones" method="post" data-field="normalizePhonesField">
					<button type="submit" class="btn btn-primary">Send Request</button>
				</form>
				<div class="container">
					<div class="row">
	...
	<div class="row gy-5">
		<div class="col-12">
			<div class="p-3">
				...
				<hr>
				<form action="/delete-duplicate-phones" method="post" data-field="deleteDuplicatePhonesField">
					<button type="submit" class="btn btn-primary">Send Request</button>
				</form>
				<div class="container">
					<div class="row">
	...
	<div class="row gy-5">
		<div class="col-12">
			<div class="p-3">
				...
				<hr>
				<form action="/order-number" method="post" data-field="orderNumberField">
					<button type="submit" class="btn btn-primary">Send Request</button>
				</form>
				<div class="container">
					<div class="row">
